...
| DS-303 | Design System Enforcement | Convert onboarding to progressive disclosure flow | in_progress | frontend | `WORKPLAN` `DS-303` | onboarding is staged with clear progress and preserved validation/API compatibility |
...
- Current active priority: `DS-303`.
