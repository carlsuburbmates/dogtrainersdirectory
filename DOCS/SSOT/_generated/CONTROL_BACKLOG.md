...
| PH-204 | Production Hardening | Restore live public directory RPC availability | in_progress | backend | `WORKPLAN` `PH-204` | `search_trainers` and `get_trainer_profile` are callable in the live project again |
