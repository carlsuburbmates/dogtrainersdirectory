...
| MO-306 | Website Completion | Reduce buyer friction with clearer primary conversion actions | in_progress | main-control | `WORKPLAN` `MO-306` | results and profiles expose a clear measurable primary CTA |
