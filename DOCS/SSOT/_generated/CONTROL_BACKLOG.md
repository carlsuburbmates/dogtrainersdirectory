...
| PH-202 | Production Hardening | Restore real Supabase remote-path validation | in_progress | backend | `WORKPLAN` `PH-202` | remote-backed smoke paths run without DNS fallback skips |
