...
| DS-304 | Design System Enforcement | Enforce primitive discipline across public surfaces | in_progress | frontend | `WORKPLAN` `DS-304` | public pages use canonical primitives for reusable state and content blocks |
...
- Current active priority: `DS-304`.
