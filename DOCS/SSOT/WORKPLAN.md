...
- `OW-927` is now the active priority: owner-workflow control substrate should make future live-readiness boundaries, overrides, and ai-health truth explicit before any later owner-live proposal.
